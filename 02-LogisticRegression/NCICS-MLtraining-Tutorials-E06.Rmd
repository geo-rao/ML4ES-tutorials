...
### Session purpose
In this session, we are introducing logistic regression for classification. The concept of regularization will also be introduced in this session.
...
fname <- "~/MLtraining/noaa-ai-ml-distribution-raju/lulc-ashville/NC_L8_GroundTruth.csv"
